...
priceFile = 'C:\\Users\BTC\\Data\\Bitcoin Historical Data.csv'
scoreFile = 'Outputs/scores_final-btc.csv'
...
df_3.to_csv('Outputs/combined_final_data-btc.csv')
...
df_3.to_csv('Outputs/combined_final_data_2-btc.csv')