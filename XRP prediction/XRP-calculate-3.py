...
datafile = 'Outputs/reduced_scores-xrp.csv'
...
df_2.to_csv('Outputs/scores_norm-xrp.csv')
df_3.to_csv('Outputs/scores_norm_avg-xrp.csv')
df_4.to_csv('Outputs/scores_final-xrp.csv')