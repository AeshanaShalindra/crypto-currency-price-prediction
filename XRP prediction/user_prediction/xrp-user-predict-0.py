...
tweets_list = tweepy.Cursor(api.search_30_day, label="devTwo", query="(@cz_binance OR @APompliano OR @aantonop OR @BTC_Archive OR @MMCrypto OR @NickSzabo4) (XRP OR ripple) -win", fromDate = 202211200000, toDate = 202211210000).items(50)
...
for category in categories:
    ...
    same_pip = joblib.load('C:\\Users\\Aeshana Udadeniya\\Documents\\Masters-USCS\\project\\work\\Demo\\XRP\\classifiers\\'+category + '_model.joblib')
...
df.to_csv('2-scores-xrp.csv')
df_2.to_csv('3-reduced_scores-xrp.csv')
...
#get the file with tweets
datafile = '3-reduced_scores-xrp.csv'
...
df_2.to_csv('4-scores_norm-xrp.csv')
df_3.to_csv('5-scores_norm_avg-xrp.csv')
df_4.to_csv('6-scores_final-xrp.csv')


######################################################### combine ###########################################

priceFile = 'C:\\Users\\Aeshana Udadeniya\\Documents\\Masters-USCS\\project\\work\\Demo\\XRP\\Data\\XRP Historical Data 2.csv'
scoreFile = '6-scores_final-xrp.csv'
