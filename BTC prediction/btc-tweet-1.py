...
tweets_list = tweepy.Cursor(api.search_full_archive, label="DevThree", query="(@cz_binance OR @APompliano OR @aantonop OR @BTC_Archive OR @MMCrypto OR @NickSzabo4) (BTC OR Bitcoin) -win", fromDate = 202110201212).items(5)
